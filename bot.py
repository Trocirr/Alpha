...
async def on_message(message):
	...
	if message.content.startswith('-suggest'):
		if message.content[9:] =="":
			...
			await client.send_message(message.channel, '<:alphaSuccess:547510448464068628> | **{0}** Your suggestion has been sent succesfully!'.format(member))
			args = message.content.split(" ")		
			...
			embed.add_field(name="By:", value="**{0}**".format(member), inline=False)
